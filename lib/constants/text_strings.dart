// -- Generic Text
const String myProvider = "Provider";
const String myRetailer = "Retailer";
...
// -- Splash Screen Text
const String myAppName = "Mealify";
const String myAppTagLine = "Transforming Leftovers into Tomorrow’s Delights!";

// -- Welcome Screen Text
const String myWelcomeTitle = "Mealify";
const String myWelcomeSubTitle = "Welcome to Mealify: Revolutionizing Food Sharing for Communities!";
...
const String myProfileHeading = "B2B Exchange";
const String myProfileSubHeading = "abc@gmail.com.com";

// -- Menu

const String myMenu5 = "Logout";
